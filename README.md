...
- 2024-07-28: ⚠️ breaking change in progress: refactoring for new backend store (4.x.x; last release with old model is 3.1.2). TODO: all versions will be bumped to 4.0.0.
